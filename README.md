...
Styled-components, responsividade e boas práticas em projetos front-end.
Criação de APIs e integração com sistemas externos.
SQL (Oracle) e Power BI.
Git e GitHub, Linux (terminal).
Figma para prototipação e design.
Fundamentos de Projetos em TI.
Metodologias ágeis.
Scrum/ Kanban.
